defmodule Thumbor.Support.StorageSandbox do
  @sleep 10
  @state "state"
  @disabled "disabled_pids"
  @registry :thumbor_storage_sandbox
  @keys :unique
  ...
  ```elixir
  Thumbor.Support.Adapters.Storage.Sandbox.set_list_objects_responses([{"bucket", fn ->
    {:ok, [
      %{
        e_tag: "etag",
        key: "key.txt",
  ...
  import Thumbor.Support.StorageSandbox, only: [disable_s3_sandbox: 1]
  ...
  defp format_example(action, bucket) do
    """
    alias Thumbor.Support.StorageSandbox
